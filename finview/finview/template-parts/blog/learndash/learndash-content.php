<?php
       ...
       $price = $course_options && isset($course_options['sfwd-courses_course_price']) ? $course_options['sfwd-courses_course_price'] : esc_html__( 'Free', 'finview' );

       $has_access   = sfwd_lms_has_access( $course_id, $user_id );
       $is_completed = learndash_course_completed( $user_id, $course_id );

       if( $price == '' )
          $price .= esc_html__( 'Free', 'finview' );
       ...
       if ( $has_access && ! $is_completed ) {
          ...
          $ribbon_text = esc_html__( 'Enrolled', 'finview' );
       } elseif ( $has_access && $is_completed ) {
          $class = 'ld_course_grid_price';
          $ribbon_text = esc_html__( 'Completed', 'finview' );
       } else {
       ...
       $cat = '';
       $cat_with_link = ''; 
       $cat_with_link = finview_ld_course_cageory_by_id($post->ID, 'ld_course_category');
         ...
         <div class="course__item white-bg mb-30 fix">
            <div class="course__thumb w-img p-relative fix">
               ...
               <div class="course__tag">
                  <?php echo finview_kses($cat_with_link);?> 
               </div>
            </div>
            <div class="course__content">
               <div class="course__meta d-flex align-items-center justify-content-between">
                  <div class="course__lesson">
                     <span><i class="far fa-book-alt"></i><?php echo count($lesson); ?> <?php echo esc_html__("Lessons","finview");?></span>
                  </div>
               </div>
            ...
            <div class="course__more d-flex justify-content-between align-items-center">
               ...
               <div class="course__btn">
                  <a href="<?php the_permalink(); ?>" class="link-btn">
                     <?php echo esc_html__("Know Details","finview");?>
