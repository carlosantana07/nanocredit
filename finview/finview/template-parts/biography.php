<?php
    ...
    $author_info = get_the_author_meta( 'finview_write_by');
    $facebook_url = get_the_author_meta( 'finview_facebook' );
    $twitter_url = get_the_author_meta( 'finview_twitter' );
    $linkedin_url = get_the_author_meta( 'finview_linkedin' );
    $instagram_url = get_the_author_meta( 'finview_instagram' );
    $finview_url = get_the_author_meta( 'finview_youtube' );
    $finview_write_by = get_the_author_meta( 'finview_write_by' );
