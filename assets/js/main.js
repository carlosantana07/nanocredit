 ...
 * Version: 1.0
 * Author: Zibacc
 * Author URI: https://themeforest.net/user/Zibacc
...
============== */
    ...
    if(document.querySelector("#range-slider-1")){
        ...
        function fillColor() {
            ...
            sliderTrack.style.background = `linear-gradient(to right, #dadae5 ${percent1}% , #134e70 ${percent1}% , #134e70 ${percent2}%, #dadae5 ${percent2}%)`;
        }
    }
